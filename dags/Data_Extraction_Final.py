...
def select_ticker(**kwargs):
  ...
  #postgreshook is added here for database connections
...
#storing extracted news data into postgres database
...
#Extract trends task begins here    
...
#twitter data extraction begins here
...
#storing extracted tweets into postgres database
...
#trigger to restart all operations
trigger = TriggerDagRunOperator(
        task_id="restart_test",
        trigger_dag_id="Data_Extraction_Final_2.0", trigger_rule=TriggerRule.ALL_DONE
    )                
